...
! function(t, e) {
    ...
    var s = function(t, e, s) {
        ...
        if ("object" == typeof e.ranges) {
            ...
            var f = "<ul>";
            for (l in this.ranges) f += "<li class=\"btnGetValueByDate\">" + l + "</li>";
