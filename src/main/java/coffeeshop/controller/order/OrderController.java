...
public class OrderController {
	...
	public String receiveListOrderProduct(@Valid @ModelAttribute("orderResource") OrderResource orderResource, BindingResult result,
		...
		//add order to db
		orderService.insertOrder(orderResource);
		return "redirect:/";
	}

	@PostMapping("")
	public String receiveOrder(@ModelAttribute("orderResource") OrderResource orderResource,@Valid @RequestBody  ListResource<@Valid OrderProductResource> data, BindingResult result, Model model)
