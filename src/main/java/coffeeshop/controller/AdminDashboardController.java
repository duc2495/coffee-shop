...
public class AdminDashboardController {
	...
	public ResponseEntity<?> getResource(@RequestParam("from") String from, @RequestParam("to") String to) {
		...
		resource.setNewOrderNumber(21);
		resource.setNewProductNumber(11);
		resource.setIncome(1341);
		ProductResource bestProduct = new ProductResource();
		bestProduct.setProductName("Name");
		resource.setBestProduct(bestProduct);
		
		resource.setTotalOrders(12);
		resource.setTotalProducts(43);
